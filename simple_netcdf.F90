...
#line 7 "simple_netcdf.F90.erb"
#line 8 "simple_netcdf.F90.erb"
!!! DO NOT EDIT THIS FILE DIRECTLY!!!
#line 9 "simple_netcdf.F90.erb"
!!! AUTO-GENERATED FROM simple_netcdf.F90.erb !!!
#line 10 "simple_netcdf.F90.erb"
...
#line 460 "simple_netcdf.F90.erb"
    ! :nodoc:
...
#line 477 "simple_netcdf.F90.erb"
...
#line 492 "simple_netcdf.F90.erb"
...
#line 495 "simple_netcdf.F90.erb"


    ! OPEN FILE AND READ VARIABLE ---

#line 501 "simple_netcdf.F90.erb"
    ! :nodoc:
...
#line 518 "simple_netcdf.F90.erb"
...
#line 521 "simple_netcdf.F90.erb"
...
#line 523 "simple_netcdf.F90.erb"
...
#line 829 "simple_netcdf.F90.erb"
    ! :nodoc:
...
#line 858 "simple_netcdf.F90.erb"
...
#line 861 "simple_netcdf.F90.erb"
...
#line 863 "simple_netcdf.F90.erb"

    ! WRITE VAR SECTION ---

#line 868 "simple_netcdf.F90.erb"
    ! :nodoc:
...
#line 895 "simple_netcdf.F90.erb"
...
#line 898 "simple_netcdf.F90.erb"
...
#line 900 "simple_netcdf.F90.erb"

    ! ATTRIBUTE SECTION ---

    ! Read an attribute from the NetCDF file

#line 906 "simple_netcdf.F90.erb"
    ! :nodoc:
    subroutine snc_get_att_str(file, var, attname, attvalue, src_file, src_line)
        ...
        write(err_msg, "('getting character(*) attribute ''',A,':',A,''' in ',A)") &
...
#line 921 "simple_netcdf.F90.erb"
...
#line 936 "simple_netcdf.F90.erb"
...
#line 906 "simple_netcdf.F90.erb"
    ...
    subroutine snc_get_attf(file, var, attname, attvalue, src_file, src_line)
        ...
        write(err_msg, "('getting real*4 attribute ''',A,':',A,''' in ',A)") &
            trim(var%name), trim(attname), trim(file%name)
        call snc_handle_error(nf90_get_att(file%ncid, var%id, attname, attvalue), &
            err_msg, src_file, src_line)
...
#line 906 "simple_netcdf.F90.erb"
    ...
    subroutine snc_get_attd(file, var, attname, attvalue, src_file, src_line)
        ...
        write(err_msg, "('getting real*8 attribute ''',A,':',A,''' in ',A)") &
            trim(var%name), trim(attname), trim(file%name)
        call snc_handle_error(nf90_get_att(file%ncid, var%id, attname, attvalue), &
            err_msg, src_file, src_line)
...
#line 939 "simple_netcdf.F90.erb"


    ! Write an attribute to the NetCDF file.

#line 944 "simple_netcdf.F90.erb"
    ! :nodoc:
    subroutine snc_put_att_str(file, var, attname, attvalue, src_file, src_line)
        type(SNCFile), intent(in) :: file
        type(SNCVar), intent(in) :: var
        character(*), intent(in) :: attname
        character(*), intent(in) :: attvalue
        character(*), intent(in), optional :: src_file
        integer, intent(in), optional :: src_line
        character(700) :: err_msg

        write(err_msg, "('creating character(*) attribute ''',A,''' for variable ',A,' in ',A)") &
...
#line 959 "simple_netcdf.F90.erb"
...
#line 974 "simple_netcdf.F90.erb"
...
#line 944 "simple_netcdf.F90.erb"
    ...
    subroutine snc_put_atti(file, var, attname, attvalue, src_file, src_line)
        ...
        write(err_msg, "('creating integer attribute ''',A,''' for variable ',A,' in ',A)") &
            trim(attname), trim(var%name), trim(file%name)
        call snc_handle_error(nf90_put_att(file%ncid, var%id, attname, attvalue), &
            err_msg, src_file, src_line)
...
#line 944 "simple_netcdf.F90.erb"
    ...
    subroutine snc_put_attf(file, var, attname, attvalue, src_file, src_line)
        ...
        write(err_msg, "('creating real*4 attribute ''',A,''' for variable ',A,' in ',A)") &
            trim(attname), trim(var%name), trim(file%name)
        call snc_handle_error(nf90_put_att(file%ncid, var%id, attname, attvalue), &
            err_msg, src_file, src_line)
...
#line 944 "simple_netcdf.F90.erb"
    ...
    subroutine snc_put_attd(file, var, attname, attvalue, src_file, src_line)
        ...
        write(err_msg, "('creating real*8 attribute ''',A,''' for variable ',A,' in ',A)") &
            trim(attname), trim(var%name), trim(file%name)
        call snc_handle_error(nf90_put_att(file%ncid, var%id, attname, attvalue), &
            err_msg, src_file, src_line)
...
#line 977 "simple_netcdf.F90.erb"
